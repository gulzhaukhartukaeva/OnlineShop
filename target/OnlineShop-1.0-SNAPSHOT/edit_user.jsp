...
<div class="addGroup" style="margin-left: 535px; margin-right: 400px; border: 1px solid aqua; padding-top: 20px; padding-right: 10px;
    ...
    <form action="editUser">
        <div class="form-group">
            ...
            <select class="form-control" id="userRole" name="userRole" style="margin-left: 180px; width: 150px; height: 30px;">
                <c:forEach var="role" items="${sessionScope.roles}">
                    <c:if test="${role.id eq userEdit.role.id}">
                        <option selected value=${role.id}>${role.name}</option>
                    </c:if>
                    <c:if test="${role.id ne userEdit.role.id}">
            ...
            <select class="form-control" id="banned" name="banned" style="margin-left: 200px; width: 110px; height: 30px;">
