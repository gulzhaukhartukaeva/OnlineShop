...
<form action="orderPage">
    <p class="totalPrice"><fmt:message key="total.price"/>: $${sessionScope.totalPriceCard}</p>
    <input type="submit" value="<fmt:message key="calculate.total.price"/>" name="update" class="btn btn-primary btn-sm" style="margin-left: 203px;">
    <section id="cart-container" class="container my-5">
        <table id="data2">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="data:image/jpg;base64,${cartItem.product.image}" class="rounded-circle"
                    ...
                    <td><input class="w-25 pl-1" value="${cartItem.product.price}" readonly style="border: none; text-align: center"
                               name="price"></td>
                    <td><input class="w-25 pl-1" value="${cartItem.amount}" type="number" name="amount" min="1" max="100"
                               style="border: none;"></td>
                    <td><form action="removeFromCart" method="get">
                            <input type="hidden" name="id" value="${cartItem.id}">
                            <input type="submit" class="btn btn-primary btn-sm" value="Remove" name="remove"
