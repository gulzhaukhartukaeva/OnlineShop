...
import com.epam.online.shop.service.action.*;
...
public class ServiceFactory {
    ...
    static {
        ...
        SERVICE_MAP.put(ActionConstants.CART_PAGE, new ShoppingCardPageAction());
        ...
        SERVICE_MAP.put(ActionConstants.ADD_TO_CART_ACTION, new AddToShoppingCardService());
        ...
        SERVICE_MAP.put(ActionConstants.CHANGE_ADDRESS_ACTION, new ChangeAddress());
