...
public class CategoryDAOImpl implements CategoryDAO {
    ...
    private void setParametersToCategory(Category category, ResultSet resultSet) throws SQLException{
    ...
    @Override
    public List<Category> takeAllLocalizedCategoryByID(Long categoryId) throws SQLException {
        List<Category> categories = new ArrayList<>();
        connectionPool = ConnectionPool.getInstance();
        connection = connectionPool.takeConnection();
    ...
    private void setParametersToCategoryList(List<Category> categories, ResultSet resultSet) throws SQLException {
        Category category = new Category();
        setParametersToCategory(category, resultSet);
        categories.add(category);
    }
