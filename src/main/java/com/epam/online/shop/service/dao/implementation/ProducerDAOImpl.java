...
public class ProducerDAOImpl implements ProducerDAO {
    ...
    private void setParametersToProducer(Producer producer, ResultSet resultSet) throws SQLException{
    ...
    @Override
    public List<Producer> takeAllLocalizedProducerByID(Long animalID) throws SQLException {
        List<Producer> producers = new ArrayList<>();
        connectionPool = ConnectionPool.getInstance();
        connection = connectionPool.takeConnection();
    ...
    private void setParametersToProducerList(List<Producer> producers, ResultSet resultSet) throws SQLException {
        Producer producer = new Producer();
        setParametersToProducer(producer, resultSet);
        producers.add(producer);
    }
